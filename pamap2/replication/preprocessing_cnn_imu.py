...
PAMAP2_DATA_FILES = ['/Protocol/subject101.dat',  # 0  -- train
                     '/Optional/subject101.dat',  # 1
                     '/Protocol/subject102.dat',  # 2
                     '/Protocol/subject103.dat',  # 3
                     '/Protocol/subject104.dat',  # 4
                     '/Protocol/subject107.dat',  # 5
                     '/Protocol/subject108.dat',  # 6
                     '/Optional/subject108.dat',  # 7
                     '/Protocol/subject109.dat',  # 8
                     '/Optional/subject109.dat',  # 9
                     '/Protocol/subject105.dat',  # 10  -- eval
                     '/Optional/subject105.dat',  # 11
                     '/Protocol/subject106.dat',  # 12  -- test
                     '/Optional/subject106.dat',  # 13
                     ]
